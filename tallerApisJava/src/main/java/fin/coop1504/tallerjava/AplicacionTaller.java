...
StringBuffer cadenaEspecial =  new StringBuffer ("Hola mundo Buffer");
cadenaEspecial.append("\n Tierra");
...
cadenas[2]= "angie";
cadenas[3]= "mayer";
String [] cadenas2 = {"JAVA", "PYTHON",".NET"};
...
//se envia el mismo objeto	
Integer numerArrayList = lista.get(0);
System.out.println(numerArrayList);
}
